            ...
            <nav class="navbar navbar-default">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index.html"><img class="img-responsive" src="{{asset('site-assets/images/logo.png')}}" alt="Logo"></a>
                    </div>
                    <!-- /navbar-header -->
                        ...
                        <div class="col-sm-4">
                            <div class="single-cta">
                                ...
                                <div class="cta-icon icon-secure">
                                    <img src="{{asset('site-assets/images/icon/13.png')}}" alt="Icon" class="img-responsive">
                                </div><!-- cta-icon -->
                        ...
                        <div class="col-sm-4">
                            <div class="single-cta">
                                ...
                                <div class="cta-icon icon-support">
                                    <img src="{{asset('site-assets/images/icon/14.png')}}" alt="Icon" class="img-responsive">
                                </div><!-- cta-icon -->
                        ...
                        <div class="col-sm-4">
                            <div class="single-cta">
                                ...
                                <div class="cta-icon icon-trading">
                                    <img src="{{asset('site-assets/images/icon/15.png')}}" alt="Icon" class="img-responsive">
                                </div><!-- cta-icon -->
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <a href="#" class="download-app">
                            <img src="{{asset('site-assets/images/icon/16.png')}}" alt="Image" class="img-responsive">
                    ...
                    <div class="col-sm-4">
                        <a href="#" class="download-app">
                            <img src="{{asset('site-assets/images/icon/17.png')}}" alt="Image" class="img-responsive">
                            <span class="pull-left">
                                <span>available on</span>
                    ...
                    <div class="col-sm-4">
                        <a href="#" class="download-app">
                            <img src="{{asset('site-assets/images/icon/18.png')}}" alt="Image" class="img-responsive">
                            <span class="pull-left">
                                <span>available on</span>
