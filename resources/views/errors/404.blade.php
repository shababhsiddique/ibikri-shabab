...
<html lang="en">
    ...
    <body class="bn" >
        <section id="main" class="clearfix home-two" style="height: 100vh">
            <!-- view-ad -->
            <div id="home-section" class="parallax-section" style="height: 100vh" >
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12" style="text-align: center">
                            ...
                            <br/><br/><br/>
                            <div class="btn-group">
                                <a href="{{url('/')}}" class="btn btn-success">@lang('Get Back to') iBikri.com</a>
                            </div>
                        </div>                        
                    </div><!-- row -->
                </div><!-- contaioner -->
